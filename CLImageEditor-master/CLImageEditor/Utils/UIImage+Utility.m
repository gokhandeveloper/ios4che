...
- (UIImage*)gaussBlur:(CGFloat)blurLevel
{
    ...
    inBuffer.width = (long)CGImageGetWidth(img);
    inBuffer.height = (long) CGImageGetHeight(img);
    ...
    outBuffer.width = (long)CGImageGetWidth(img);
    outBuffer.height = (long) CGImageGetHeight(img);
